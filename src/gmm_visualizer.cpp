...
public:
    Visualizer()
    {
        ...
        publisher = this->create_publisher<visualization_msgs::MarkerArray>("/gmm_markers", 1);
        timer_ = this->create_wall_timer(1000ms, std::bind(&Visualizer::show, this));
        gmmSub_ = this->create_subscription<gmm_msgs::GMM>("/gaussian_mixture_model", 1, std::bind(&Visualizer::gmm_callback, this, _1));
